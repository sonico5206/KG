...
public class ImageEdit {
                ...
                try {
                    ...
                    if(input != null && !input.isEmpty()) {
                        ...
                        if(numbers.length == 4) {
                            ...
                            drawLineSbS((Graphics2D) imag.getGraphics(), x1 * gridWidth, y1 * gridWidth, x2 * gridWidth, y2 * gridWidth, false);
                ...
                try {
                    ...
                    if(input != null && !input.isEmpty()) {
                        ...
                        if(numbers.length == 4) {
                            ...
                            startTime = System.nanoTime();
                            drawLineBr((Graphics2D) imag.getGraphics(), x1 * gridWidth, y1 * gridWidth, x2 * gridWidth, y2 * gridWidth, false);
                            endTime = System.nanoTime();
            ...
            public void mouseDragged(MouseEvent e) {
                if(pressed) {
                    ...
                    switch(rezhim) {
                        ...
                        case 1:
                            clearArrays();
                            g2.setStroke(new BasicStroke(100000.0f));
                            drawLineBr(g2, xPad, yPad, e.getX(), e.getY(), false);
                            drawGrid(g2);
                            break;
                    }
            ...
            public void mouseReleased(MouseEvent e) {
                ...
                switch(rezhim) {
                    ...
                    case 2:
                        ...
                        drawLineSbS(g2, xf / gridWidth, yf / gridWidth, e.getX() / gridWidth, e.getY() / gridWidth, true);
                    ...
                    case 4:
                        ...
                        drawLineBr(g2, xf / gridWidth, yf / gridWidth, e.getX() / gridWidth, e.getY() / gridWidth, true);
    ...
    public void drawGrid(Graphics2D g2) {
        ...
        Font fontX = new Font("Serif", Font.BOLD, 20);
        g2.setFont(fontX);
        g2.drawString("X", width - 20, 40);
